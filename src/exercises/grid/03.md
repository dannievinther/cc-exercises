...
Definér tre lige brede kolonner og sæt rækkehøjden til `50px` med `grid-auto-rows`. `.box-2` skal spænde over to rækker og to kolonner, startende i række 2, kolonne 2.
