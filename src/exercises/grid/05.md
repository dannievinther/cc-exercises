...
Definér fire lige brede kolonner (`1fr`) vha. `repeat()`-funktionen. Lad `.box-1` spænde over 2 rækker og 2 kolonner, og lad `.box-4` spænde over 2 rækker. Du kan evt. tilføje gap, for at lave mellemrum mellem boksene.
