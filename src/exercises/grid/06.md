...
Definér fire lige brede kolonner og sæt rækkehøjden til `50px` med `grid-auto-rows`. Hver boks skal spænde over to rækker og to kolonner og skal overlappe hinanden (se reference). Placér boksene vha. linjenumrene i dit grid; fx `1 / 3`.
