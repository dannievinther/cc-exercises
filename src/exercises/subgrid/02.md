...
Definér to lige brede kolonner og to rækker med `auto`. Lav derefter `.box` til en grid-container, og lad den arve række-definitionerne fra `.container` ved at anvende `grid-template-rows:` `subgrid`.
